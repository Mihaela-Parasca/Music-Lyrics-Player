...
void loop() {
  ...
  if (digitalRead(BUTTON_PIN) == 0) {
    if (counter == 0) {
      mesaj = "We lost - Anoraak - Lyrics";
      KeyStrokeAlpNum(mesaj);
      UsbKeyboard.sendKeyStroke(KEY_ENTER);
      UsbKeyboard.sendKeyStroke(KEY_ENTER);
      mesaj = "Oh the mess I made";
      KeyStrokeAlpNum(mesaj);
      mesaj = "The mess I made";
      KeyStrokeAlpNum(mesaj);
      mesaj = "Of lovin' you";
      KeyStrokeAlpNum(mesaj);
      mesaj = "Because I had no clue";
      KeyStrokeAlpNum(mesaj);
      mesaj = "I had no clue";
      KeyStrokeAlpNum(mesaj);
      mesaj = "How to hold you";
      KeyStrokeAlpNum(mesaj);
      mesaj = "As you grew";
      KeyStrokeAlpNum(mesaj);
      mesaj = "Oh it's taking time";
      KeyStrokeAlpNum(mesaj);
      mesaj = "To stand up again";
      KeyStrokeAlpNum(mesaj);
      mesaj = "But we shouldn't let it go";
      KeyStrokeAlpNum(mesaj);
      mesaj = "Because there's no way to know";
      KeyStrokeAlpNum(mesaj);
      mesaj = "Cause there's no way to know";
      KeyStrokeAlpNum(mesaj);
      mesaj = "Cause there's no way to know, ooooh";
      KeyStrokeAlpNum(mesaj);
    }
    if (counter == 1) {
      mesaj = "We'll never know";
      KeyStrokeAlpNum(mesaj);
      mesaj = "No we'll never know";
      KeyStrokeAlpNum(mesaj);
      mesaj = "No we'll never know what we lost, ooooh";
      KeyStrokeAlpNum(mesaj);
      mesaj = "We'll never know";
      KeyStrokeAlpNum(mesaj);
      mesaj = "No we'll never know";
      ...
      mesaj = "No we'll never know what we lost, ooooh";
      KeyStrokeAlpNum(mesaj);
      mesaj = "And the mess you made";
      KeyStrokeAlpNum(mesaj);
      mesaj = "The mess you made";
      KeyStrokeAlpNum(mesaj);
      mesaj = "Of lovin' me";
      KeyStrokeAlpNum(mesaj);
      mesaj = "Cause you didn't know";
      KeyStrokeAlpNum(mesaj);
      mesaj = "You didn't know";
      KeyStrokeAlpNum(mesaj);
      mesaj = "The mess you made";
      KeyStrokeAlpNum(mesaj);
      mesaj = "How to deal with me";
      KeyStrokeAlpNum(mesaj);
    }
    if (counter == 2) {
      mesaj = "Oh it's taking time";
...
void KeyStrokeAlpNum(String Sc) {
  ...
  for (int x = 0; x < sPoint; x++) {
    ...
    if (Sc.substring(x, y) == " ") {
      ...
      UsbKeyboard.sendKeyStroke(KEY_APOST);
    } else if (Sc.substring(x, y) == ",") {
